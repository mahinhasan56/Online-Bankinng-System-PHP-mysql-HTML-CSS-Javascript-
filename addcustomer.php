...
<form action="add_customer.php" method="POST">
            <table align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="initial" value="5000" min="5000" required 5000=""/></td>
                </tr>
                ...
                <tr>
                    ...
                    <input type="submit" name="add_customer" value="Add Customer" class="addstaff_button"/></td>
                </tr>
            </table>
            </div>
    </div>
