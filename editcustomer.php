...
<?php
                        ...
                        if(isset($_REQUEST['submit2_id'])){
                            ...
                            $sql_drop="DROP TABLE accountrecord".$delete_id;
    ...
    <?php include 'admin_navbar.php'?>
            ...
            <table align="center">
                ...
                <tr>
                    <td>gender</td>
                    <td>
                        M<input type="radio" name="edit_gender" value="M" <?php if($rows[2]=="M") echo "checked";?>/>
                        F<input type="radio" name="edit_gender" value="F" <?php if($rows[2]=="F") echo "checked";?>/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="date" name="edit_dateOfBirth" value="<?php echo $rows[3];?>"/>
                    </td>
                </tr>
                <tr>
                    <td>Nominee</td>
                    <td><input type="text" name="edit_nominee" value="<?php echo $rows[4];?>" required=""/></td>
                </tr>
                <tr>
                    <td>account type</td>
                    <td>
                        <select name="edit_account">
                            <option <?php if($rows[5]=="savings") echo "selected";?>>savings</option>
                            <option <?php if($rows[5]=="current") echo "selected";?>>current</option>
                        </select>
                    </td>
                </tr>
